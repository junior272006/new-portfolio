...
const contacts = [
  {
    label: "Email",
    value: "junior27nguetta@gmail.com",
    href: "https://mail.google.com/mail/?view=cm&to=junior27nguetta@gmail.com",
    icon: (
  ...
  return (
    <section id="contact" className="contact">
      ...
      <p className="contact__intro">
        Disponible pour un stage, une mission ou simplement échanger. N'hésitez pas à me contacter.
      </p>
